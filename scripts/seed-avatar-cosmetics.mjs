...
const ITEMS = [
  ...
  // Escritório customizável
  { slug: "office_desk", name: "Mesa Básica", category: "office_item", icon: "🪑", unlock_level: 1, price_coins: 0, is_default: true, rarity: "common" },
  { slug: "office_plant", name: "Planta", category: "office_item", icon: "🪴", unlock_level: 1, price_coins: 20, is_default: false, rarity: "common" },
  { slug: "office_monitor", name: "Monitor", category: "office_item", icon: "🖥️", unlock_level: 2, price_coins: 30, is_default: false, rarity: "common" },
  { slug: "office_laptop", name: "Notebook", category: "office_item", icon: "💻", unlock_level: 3, price_coins: 50, is_default: false, rarity: "common" },
  { slug: "office_coffee", name: "Cafeteira", category: "office_item", icon: "☕", unlock_level: 1, price_coins: 40, is_default: false, rarity: "common" },
  { slug: "office_board", name: "Quadro Branco", category: "office_item", icon: "📋", unlock_level: 5, price_coins: 75, is_default: false, rarity: "rare" },
  { slug: "office_trophy", name: "Estante de Troféus", category: "office_item", icon: "🏆", unlock_level: 8, price_coins: 100, is_default: false, rarity: "rare" },
  { slug: "office_gaming", name: "Setup Gamer", category: "office_item", icon: "🎮", unlock_level: 12, price_coins: 200, is_default: false, rarity: "epic" },
  { slug: "office_rocket", name: "Foguete Decorativo", category: "office_item", icon: "🚀", unlock_level: 15, price_coins: 300, is_default: false, rarity: "epic" },
  { slug: "office_diamond", name: "Diamante Corporativo", category: "office_item", icon: "💎", unlock_level: 20, price_coins: 500, is_default: false, rarity: "legendary" },
  { slug: "office_sofa", name: "Sofá Executivo", category: "office_item", icon: "🛋️", unlock_level: 6, price_coins: 120, is_default: false, rarity: "rare" },
  { slug: "office_bookshelf", name: "Estante de Livros", category: "office_item", icon: "📚", unlock_level: 4, price_coins: 80, is_default: false, rarity: "common" },
  { slug: "office_whiteboard", name: "Lousa Inteligente", category: "office_item", icon: "🖊️", unlock_level: 7, price_coins: 150, is_default: false, rarity: "rare" },
  { slug: "office_chandelier", name: "Luminária Design", category: "office_item", icon: "💡", unlock_level: 3, price_coins: 60, is_default: false, rarity: "common" },
  { slug: "office_painting", name: "Quadro Motivacional", category: "office_item", icon: "🖼️", unlock_level: 2, price_coins: 40, is_default: false, rarity: "common" },
  { slug: "office_arcade", name: "Arcade Retrô", category: "office_item", icon: "🕹️", unlock_level: 18, price_coins: 400, is_default: false, rarity: "epic" },
  { slug: "office_minibar", name: "Minibar Corporativo", category: "office_item", icon: "🍹", unlock_level: 10, price_coins: 200, is_default: false, rarity: "rare" },
  { slug: "office_rug", name: "Tapete Persa", category: "office_item", icon: "🏠", unlock_level: 2, price_coins: 50, is_default: false, rarity: "common" },
  { slug: "office_robot_helper", name: "Assistente Robô", category: "office_item", icon: "🤖", unlock_level: 22, price_coins: 600, is_default: false, rarity: "legendary" },
  { slug: "office_hologram", name: "Mesa Holográfica", category: "office_item", icon: "🔮", unlock_level: 25, price_coins: 800, is_default: false, rarity: "mythic" },

  // Visuais do escritório
  { slug: "office_theme_classic", name: "Clássico Produtivo", category: "office_theme", icon: "🏢", unlock_level: 1, price_coins: 0, is_default: true, rarity: "common" },
  { slug: "office_theme_minimal", name: "Minimalista Branco", category: "office_theme", icon: "⚪", unlock_level: 2, price_coins: 90, is_default: false, rarity: "common" },
  { slug: "office_theme_neon", name: "Neon Gamer", category: "office_theme", icon: "🌌", unlock_level: 8, price_coins: 220, is_default: false, rarity: "rare" },
  { slug: "office_theme_nature", name: "Natureza Zen", category: "office_theme", icon: "🌿", unlock_level: 5, price_coins: 160, is_default: false, rarity: "rare" },
  { slug: "office_theme_luxury", name: "Executivo Luxo", category: "office_theme", icon: "🥇", unlock_level: 14, price_coins: 420, is_default: false, rarity: "epic" },
  { slug: "office_theme_space", name: "Espacial Cósmico", category: "office_theme", icon: "🪐", unlock_level: 24, price_coins: 750, is_default: false, rarity: "mythic" },
  { slug: "office_theme_industrial", name: "Café Industrial", category: "office_theme", icon: "☕", unlock_level: 6, price_coins: 180, is_default: false, rarity: "rare" },
  { slug: "office_theme_ocean", name: "Oceano Profundo", category: "office_theme", icon: "🌊", unlock_level: 10, price_coins: 260, is_default: false, rarity: "rare" },
  { slug: "office_theme_aurora", name: "Aurora Criativa", category: "office_theme", icon: "🎨", unlock_level: 16, price_coins: 480, is_default: false, rarity: "epic" },
  { slug: "office_theme_cyber_exec", name: "Cyberpunk Executivo", category: "office_theme", icon: "🧬", unlock_level: 28, price_coins: 900, is_default: false, rarity: "mythic" },
