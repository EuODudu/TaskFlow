...
export const FURNITURE_SPRITES: Record<string, (color: string) => React.ReactNode> = {
  office_desk: (c) => (
    <g>
      <rect x="4" y="12" width="56" height="36" rx="4" fill={c} />
      <rect x="4" y="10" width="56" height="6" rx="2" fill="#ffffff30" />
      <rect x="6" y="42" width="8" height="16" rx="2" fill={c} filter="brightness(0.8)" />
      <rect x="50" y="42" width="8" height="16" rx="2" fill={c} filter="brightness(0.8)" />
      <rect x="14" y="16" width="32" height="20" rx="3" fill="#1a1a2e" />
      <rect x="16" y="18" width="28" height="16" rx="2" fill="#0f172a" />
      <rect x="20" y="22" width="18" height="8" rx="1" fill="#1e40af" opacity="0.6" />
    </g>
  ),
  office_plant: (c) => (
    <g>
      ...
      <ellipse cx="24" cy="16" rx="4" ry="6" fill={c} opacity="0.85" transform="rotate(-18 24 16)" />
  ...
  office_monitor: (c) => (
    <g>
      <rect x="12" y="8" width="40" height="30" rx="4" fill="#1a1a2e" />
      <rect x="14" y="10" width="36" height="26" rx="3" fill="#0f172a" />
      <rect x="16" y="12" width="32" height="22" rx="2" fill={c} opacity="0.8" />
      <rect x="18" y="14" width="28" height="14" rx="1" fill="#1e293b" />
      <line x1="18" y1="18" x2="46" y2="18" stroke={c} strokeWidth="0.8" opacity="0.6" />
      <line x1="18" y1="22" x2="42" y2="22" stroke={c} strokeWidth="0.8" opacity="0.6" />
      <rect x="28" y="36" width="8" height="10" rx="1" fill="#334155" />
      <rect x="20" y="44" width="24" height="4" rx="2" fill="#334155" />
    </g>
  ),
  office_laptop: (c) => (
    <g>
      <rect x="8" y="20" width="48" height="30" rx="3" fill="#334155" />
      <rect x="10" y="22" width="44" height="26" rx="2" fill="#1e293b" />
      <rect x="12" y="24" width="40" height="22" rx="1" fill={c} opacity="0.7" />
      <path d="M 4 50 Q 4 54 8 54 L 56 54 Q 60 54 60 50 Z" fill="#475569" />
      <rect x="26" y="52" width="12" height="2" rx="1" fill="#94a3b8" />
    </g>
  ),
  office_coffee: (c) => (
    <g>
      <ellipse cx="32" cy="50" rx="16" ry="8" fill="#92400e" />
      <rect x="18" y="24" width="28" height="28" rx="6" fill="#d97706" />
      <rect x="20" y="26" width="24" height="24" rx="5" fill={c} />
      <path d="M 46 30 Q 54 32 54 38 Q 54 44 46 44" stroke="#d97706" strokeWidth="3" fill="none" />
      <ellipse cx="32" cy="30" rx="10" ry="3" fill="#92400e" opacity="0.6" />
      <path d="M 28 10 Q 30 4 32 10 Q 34 4 36 10" stroke="#94a3b8" strokeWidth="1.5" fill="none" opacity="0.7" />
    </g>
  ),
  office_board: (c) => (
    <g>
  ...
  office_whiteboard: (c) => (
    <g>
      ...
      <path d="M 13 34 Q 24 18 34 27 Q 43 35 52 16" stroke={c} strokeWidth="3" fill="none" strokeLinecap="round" />
  ...
  office_painting: (c) => (
    <g>
      ...
      <path d="M 10 36 Q 18 20 28 28 Q 38 36 46 18 L 54 24 L 54 40 L 10 40 Z" fill={c} opacity="0.6" />
  ...
  office_wall_window: (c) => (
    <g>
      ...
      <rect x="5" y="10" width="54" height="38" rx="8" fill="none" stroke="#1e40af" strokeWidth="2" opacity="0.55" />
      <path d="M 13 17 L 24 17" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" opacity="0.9" />
    </g>
  ),
  office_wall_clock: (c) => (
    <g>
      ...
      <path d="M 32 16 V 29 L 44 29" stroke="#1e3a8a" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M 32 8 V 12 M 32 48 V 52 M 10 30 H 14 M 50 30 H 54" stroke={c} strokeWidth="2" strokeLinecap="round" opacity="0.7" />
  ...
  office_wall_neon_sign: (c) => (
    <g>
      ...
      <rect x="10" y="19" width="44" height="24" rx="7" fill="#020617" stroke={c} strokeWidth="2" opacity="0.95" />
      <path d="M 18 32 H 28 L 32 25 L 36 38 L 41 29 H 47" stroke={c} strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M 18 32 H 28 L 32 25 L 36 38 L 41 29 H 47" stroke="#ffffff" strokeWidth="1" fill="none" strokeLinecap="round" opacity="0.75" />
  ...
  office_robot_helper: (c) => (
    <g>
      ...
      <path d="M 28 39 Q 32 42 36 39" stroke="#0f172a" strokeWidth="2" fill="none" strokeLinecap="round" />
...
export function FurnitureSVG({ item, size = 60 }: { item: AvatarItem; size?: number }) {
  ...
  const color = (item as any).color_hint ?? RARITY_STYLES[rarity]?.color ?? "#94a3b8";
  ...
  if (item.category === "office_theme") {
    ...
    return (
      <svg viewBox="0 0 64 64" width={size} height={size} style={{ overflow: "visible" }}>
        ...
        <rect x="4" y="6" width="56" height="52" rx="10" fill={theme.trim} opacity="0.95" filter={`url(#${item.slug}-soft-shadow)`} />
        ...
        <path d="M 8 36 L 56 31 L 56 54 L 8 54 Z" fill={`url(#${item.slug}-shine)`} opacity="0.55" />
  ...
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} style={{ overflow: "visible" }}>
      ...
      <g filter={`url(#${filterId})`}>
        ...
        <path d="M 8 10 Q 32 0 56 12 L 56 22 Q 32 12 8 22 Z" fill={`url(#${glossId})`} opacity="0.55" />
      </g>
    </svg>
  );
}
